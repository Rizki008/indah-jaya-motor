			...
			<div class="col-12 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" action="<?= base_url('diskon/add') ?>" method="POST">
							...
							<div class="form-group">
								...
								<input type="text" value="<?= set_value('harga') ?>" name="harga" class="harga form-control" id="exampleInputName1" readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" value="<?= set_value('nama_diskon') ?>" name="nama_diskon" class="form-control" id="exampleInputName1" placeholder="Nama Diskon">
							</div>
							<div class="form-group">
								<label for="exampleInputName1">Besar Diskon</label>
								<input type="number" value="<?= set_value('diskon') ?>" name="diskon" class="form-control" id="exampleInputName1" placeholder="Besar Diskon">
							</div>
							<div class="form-group">
								<label>Tanggal Selesai</label>
								<input type="date" value="<?= set_value('tgl') ?>" name="tgl" class="form-control" placeholder="dd/mm/yyyy" />
							</div>
