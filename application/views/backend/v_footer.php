...
<!-- All js here -->
<script type="text/javascript" src="<?= base_url() ?>frontend/assets/js/jquery-min.js"></script>
<script type="text/javascript" src="<?= base_url() ?>frontend/assets/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?= base_url() ?>frontend/assets/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="<?= base_url() ?>frontend/assets/js/classie.js"></script>
<script type="text/javascript" src="<?= base_url() ?>frontend/assets/js/slick.min.js"></script>
<script type="text/javascript" src="<?= base_url() ?>frontend/assets/js/jquery.slicknav.js"></script>
