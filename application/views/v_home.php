		...
		<div class="row">
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="feature-item-content">
					<img src="<?= base_url() ?>frontend/assets/img/feature/img1.jpg" alt="">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="feature-item-content">
					<img src="<?= base_url() ?>frontend/assets/img/feature/img3.jpg" alt="">
					<div class="feature-content">
						<div class="banner-text">
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="feature-item-content mb-30">
					<img src="<?= base_url() ?>frontend/assets/img/feature/img2.jpg" alt="">
					<div class="feature-content">
				...
				<div class="feature-item-content">
					<img src="<?= base_url() ?>frontend/assets/img/feature/img4.jpg" alt="">
					<div class="feature-content">
						<div class="banner-text accessories">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-01.jpg" alt=""></a>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-02.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-03.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
						<div class="actions">
							<div class="add-to-links">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-04.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-05.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
						<span class="sticker sale"><strong>Sale</strong></span>
						<div class="actions">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-06.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
						<div class="actions">
							<div class="add-to-links">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-07.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
						<span class="sticker new"><strong>NEW</strong></span>
						<div class="actions">
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="shop-product">
					<div class="product-box">
						<a href="#"><img src="<?= base_url() ?>frontend/assets/img/products/img-08.jpg" alt=""></a>
						<div class="cart-overlay">
						</div>
						<div class="actions">
							<div class="add-to-links">
			...
			<div class="col-md-12">
				<div id="new-products" class="owl-carousel">
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-01.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<span class="sticker new"><strong>NEW</strong></span>
								<div class="actions">
					...
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-02.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<div class="actions">
									<div class="add-to-links">
					...
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-03.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<span class="sticker sale"><strong>Sale</strong></span>
								<div class="actions">
					...
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-04.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<div class="actions">
									<div class="add-to-links">
					...
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-05.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<span class="sticker discount"><strong>-40%</strong></span>
								<div class="actions">
					...
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-06.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<div class="actions">
									<div class="add-to-links">
					...
					<div class="item">
						<div class="shop-product">
							<div class="product-box">
								<a href="#"><img src="<?= base_url() ?>frontend/assets/img/feature-products/img-07.jpg" alt=""></a>
								<div class="cart-overlay">
								</div>
								<span class="sticker sale"><strong>Sale</strong></span>
								<div class="actions">
		...
		<div class="row">
				...
				<div class="blog-item">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="<?= base_url() ?>frontend/assets/img/blog/img1.jpg" alt="">
						</a>
						<div class="mask">
						</div>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="blog-item">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="<?= base_url() ?>frontend/assets/img/blog/img2.jpg" alt="">
						</a>
						<div class="mask">
						</div>
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="blog-item">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="<?= base_url() ?>frontend/assets/img/blog/img3.jpg" alt="">
						</a>
						<div class="mask">
						</div>
					</div>
		...
		<div class="row">
			<div id="client-logo" class="owl-carousel">
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-01.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-02.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-03.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-04.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-05.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-06.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-07.png" alt="" />
					</a>
				</div>
				<div class="client-logo item">
					<a href="#">
						<img src="<?= base_url() ?>frontend/assets/img/clients/logo-08.png" alt="" />
					</a>
				</div>
			</div>
		</div>
